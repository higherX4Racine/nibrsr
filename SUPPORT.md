...
Thanks for using nibrsr! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/higherX4Racine/nibrsr/issues/new).
...
requests](https://github.com/higherX4Racine/nibrsr/issues) to make sure
